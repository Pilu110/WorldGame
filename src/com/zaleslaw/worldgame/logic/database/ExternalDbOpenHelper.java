...
public class ExternalDbOpenHelper extends SQLiteOpenHelper {
	...
	public ExternalDbOpenHelper(Context context, String databaseName) {
		...
		// Составим полный путь к базам для приложения
	...
	public SQLiteDatabase openDataBase() throws SQLException {
		...
		if (database == null) {
			...
			/*try {
				...
				Log.e(this.getClass().toString(), "Create error");
			}*/
	...
	public synchronized void close() {
	 ...
	 public void selectData(ArrayList<String> list, String TABLE_NAME) {
		 //выбор полученых данных
	        Cursor cursor = database.query(TABLE_NAME, new String[] {"name"}, null, null, null, null, "name ASC"); //используем класс Cursor для работы с получеными данными
